...
def get_model(base_model, loss_method, input_shape, num_classes, embedding_size, **kwargs):
  # Image inputs
...
def run(logdir, model_name, opt_name, loss_name):
  ...
  dataset = VGGFace2(input_dir, image_size, epochs, batch_size, split_ratio=valid_split_ratio, num_gpus=FLAGS.num_gpus)
